        ...
        <div id="how_works" className="my-10 ">
                <div className=" pr-4">
                    ...
                    <div className=" md:grid grid-cols-4 mt-6 gap-3 animate__animated animate__bounce animate__delay-1s ">
                        <div className="bg-[#f3f3f3] shadow-lg p-3">
                        ...
                        <div className="bg-[rgba(255,255,255,0.8)] shadow-lg p-3">
                        ...
                        <div className="bg-[#f7f7f7] shadow-lg p-3 ">
                        ...
                        <div className="bg-[#f9f9f9] shadow-lg p-3">
